...
`r icon_style(icons::fontawesome("chart-bar"), scale = 2, fill = "#035AA6")` $~~~$ **Crowdsourced Data Analysis**  
...
Highly **inclusive** (sourcing citizens) or highly **selective** (sourcing specialists)    
