...
`r icon_style(icons::fontawesome("users"), scale = 2, fill = "#035AA6")` $~~$ **Crowdsourcing Science** 
`r icon_style(icons::fontawesome("chart-bar"), scale = 2, fill = "#035AA6")` $~~~$ **Crowdsourcing Data Analysis**  
`r icon_style(icons::fontawesome("question-circle"), scale = 2, fill = "#035AA6")` $~~~$ **Lay Perceptions: Are Crowd-Scientific Findings More Credible?**   
`r icon_style(icons::fontawesome("tools"), scale = 2, fill = "#035AA6")` $~~~$ **Method**
`r icon_style(icons::fontawesome("chart-line"), scale = 2, fill = "#035AA6")` $~~~$ **Results**
`r icon_style(icons::fontawesome("comment"), scale = 2, fill = "#035AA6")` $~~~$ **Discussion**
...
`r icon_style(icons::fontawesome("chart-line"), scale = 2, fill = "#035AA6")` $~~~~$ On the **rise** in behavioral science
