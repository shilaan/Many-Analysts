...
```{r, echo = FALSE, out.width='101%', fig.retina=3, fig.align='left'}
knitr::include_graphics("mermaid.png")
```

# Results

**Figure 1**: *Estimates (and 95% CIs) for all outcomes*  

```{r, echo = FALSE, out.width='90%', fig.retina=3, fig.align='left'}
...
```{r, echo = FALSE, out.width='92%', fig.retina=3, fig.align='center'}
knitr::include_graphics("Figure2.jpg")
```

# Discussion  
**Conclusions**  
`r icon_style(icons::fontawesome("sitemap"), scale = 1.4, fill = "#035AA6")` $~$ Crowdsourced data analysis has **many worthy uses**, but...    
`r icon_style(icons::fontawesome("exclamation-triangle"), scale = 1.4, fill = "#035AA6")` $~~$ **Variability** and  **lack of consensus** may evoke negative responses   
...
`r icon_style(icons::fontawesome("github"), scale = 1.5, fill = "#035AA6")` $~~$ [Insert GitHub link here]   
`r icon_style(icons::academicons("osf"), scale = 1.5, fill = "#035AA6")` $~~$ [Insert OSF link here]  