...
`r icon_style(icons::fontawesome("hand-holding-usd"), scale = 1.3, fill = "#035AA6")` $~~$ It's highly **resource-intensive**, and...    
...
`r icon_style(icons::fontawesome("question-circle"), scale = 1.3, fill = "#035AA6")` $~~$ Surprisingly, **multiple, consistent estimates may backfire**
