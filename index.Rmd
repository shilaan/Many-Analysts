...
`r icon_style(icons::fontawesome("sitemap"), scale = 1.5, fill = "#035AA6")`   $~$ Crowdsourced data analysis has **many worthy uses**  
...
`r icon_style(icons::fontawesome("users-slash"), scale = 1.4, fill = "#035AA6")` $~~$ Lay consumers may respond negatively to **variability** and  **lack of consensus**   
--
